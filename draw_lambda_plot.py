...
# last
continuous_auc = [67.63, 67.53, 67.85, 67.76, 67.83]
continuous_auc_std = [0.95, 0.86, 0.51, 0.65, 0.73]

# avg
continuous_last = [59.62, 59.57, 59.80, 59.77, 59.78]
continuous_last_std = [0.17, 0.04, 0.15, 0.14, 0.09]
...
ax1.set_xscale('log')
ax1.set_xticks(k, [r"$\frac{1}{8}$",r"$\frac{1}{4}$",r"$\frac{1}{2}$",r"$1$",r"$2$"], fontsize=9)
y_labels = [66.5,67.0,67.5,68.0,68.5,69.0]
...
ax2.set_xscale('log')
ax2.set_xticks(k, [r"$\frac{1}{8}$",r"$\frac{1}{4}$",r"$\frac{1}{2}$",r"$1$",r"$2$"], fontsize=9)
y_labels = [59.5, 59.75, 60.0]
ax2.set_yticks(y_labels, y_labels, fontsize=9)
ax2.yaxis.grid()

# ax2.plot(k, continuous_auc, label="A_auc")
# ax2.plot(k, continuous_last, label="A_last")
plt.suptitle(r"Effect of Orthogonality regularization scale $\lambda$", fontsize=13)
plt.tight_layout(pad=0.3, h_pad=-0.01, w_pad=0.8)
plt.savefig("effect_reg_lambda.pdf")