...
# last
continuous_auc = [67.85, 67.88, 68.06, 68.19, 68.11, 67.08]
continuous_auc_std = [0.48, 0.64, 0.22, 1.05, 0.37, 1.34]

# avg
continuous_last = [58.39, 58.46, 59.87, 59.14, 58.66, 54.92]
continuous_last_std = [0.73, 0.48, 0.08, 0.58, 0.63, 1.98]
...
ax1.set_xlabel(r"Low rank $r$", fontsize=11)
ax1.set_ylabel(r'$A_{last}$', fontsize=12)
ax1.set_xscale('log')
ax1.set_xticks(k, [r"$32$",r"$64$",r"$128$",r"$256$",r"$512$",r"$1024$"], fontsize=9)
ax1.set_yticks(range(66, 72, 1), range(66, 72, 1), fontsize=9)
ax1.yaxis.grid()
...
ax2.set_xlabel(r"Low rank $r$", fontsize=11)
ax2.set_ylabel(r'$A_\text{AUC}$', fontsize=12)
ax2.set_xscale('log')
ax2.set_xticks(k, [r"$32$",r"$64$",r"$128$",r"$256$",r"$512$",r"$1024$"], fontsize=9)
ax2.set_yticks(range(52, 62, 2), range(52, 62, 2), fontsize=9)
ax2.yaxis.grid()

# ax2.plot(k, continuous_auc, label="A_auc")
# ax2.plot(k, continuous_last, label="A_last")
plt.suptitle(f"Effect of Low rank $r$ of PQ-LoRA", fontsize=13)
plt.tight_layout(pad=0.3, h_pad=-0.01, w_pad=0.8)
plt.savefig("effect_lora_rank.pdf")