...
class PQLoraLayer(BaseTunerLayer):
...
class Linear(nn.Module, PQLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQLoraLayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, PQLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQLoraLayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, PQLoraLayer):
