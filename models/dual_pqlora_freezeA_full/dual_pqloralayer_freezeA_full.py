...
class PQLoraFullFreezeALayer(BaseTunerLayer):
...
class Linear(nn.Module, PQLoraFullFreezeALayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQLoraFullFreezeALayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, PQLoraFullFreezeALayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQLoraFullFreezeALayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, PQLoraFullFreezeALayer):
