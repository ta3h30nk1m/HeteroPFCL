...
class PQMOELoraFullFreezeALayer(BaseTunerLayer):
...
class Linear(nn.Module, PQMOELoraFullFreezeALayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQMOELoraFullFreezeALayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, PQMOELoraFullFreezeALayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQMOELoraFullFreezeALayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, PQMOELoraFullFreezeALayer):
