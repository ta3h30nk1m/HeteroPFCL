...
class PQMOELoraFullFreezeBLayer(BaseTunerLayer):
...
class Linear(nn.Module, PQMOELoraFullFreezeBLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQMOELoraFullFreezeBLayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, PQMOELoraFullFreezeBLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQMOELoraFullFreezeBLayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, PQMOELoraFullFreezeBLayer):
