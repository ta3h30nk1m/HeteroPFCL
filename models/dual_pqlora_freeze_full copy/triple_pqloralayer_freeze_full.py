...
class TriplePQLoraFullFreezeLayer(BaseTunerLayer):
    ...
    def _mixed_batch_forward(
        ...
        for i, active_adapter in enumerate(unique_adapters):
            ...
            if self.active_state == 'lora1':
                ...
                lora_output = (lora3_B(lora3_A(dropout(sub_batch))@lora3_P + lora3_Q) + lora2_B(lora2_A(dropout(sub_batch))@lora2_P + lora2_Q)) * scaling / 2
...
class Linear(nn.Module, TriplePQLoraFullFreezeLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        TriplePQLoraFullFreezeLayer.__init__(self, base_layer, **kwargs)
                ...
                if not self.use_dora[active_adapter]:
                    if self.use_pq:
                        if self.active_state == 'lora1':
                            ...
                            result = result + (lora3_B(lora3_A(dropout(x)) @ lora3_P + lora3_Q) + lora2_B(lora2_A(dropout(x)) @ lora2_P + lora2_Q)) * scaling / 2
                    else:
                        if self.active_state == 'lora1':
...
class Embedding(nn.Module, TriplePQLoraFullFreezeLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        TriplePQLoraFullFreezeLayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, TriplePQLoraFullFreezeLayer):
