...
class PQMOELoraFullLayer(BaseTunerLayer):
...
class Linear(nn.Module, PQMOELoraFullLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQMOELoraFullLayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, PQMOELoraFullLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQMOELoraFullLayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, PQMOELoraFullLayer):
