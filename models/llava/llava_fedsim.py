...
from transformers.generation.utils import GenerateNonBeamOutput, GenerationConfig, GenerateEncoderDecoderOutput, GenerateDecoderOnlyOutput
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(
            ...
            if is_prefill:
                outputs2 = self(**model_inputs, return_dict=True)
                is_prefill = False
            else:
                outputs2 = model_forward(**model_inputs, return_dict=True)
