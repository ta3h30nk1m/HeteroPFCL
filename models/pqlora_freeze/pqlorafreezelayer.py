...
class PQLoraFreezeLayer(BaseTunerLayer):
    ...
    def update_layer(
        ...
        self.loraT_P[adapter_name] = nn.Parameter(torch.ones((r)))  # Initialized to 1
...
class Linear(nn.Module, PQLoraFreezeLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQLoraFreezeLayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, PQLoraFreezeLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        PQLoraFreezeLayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, PQLoraFreezeLayer):
