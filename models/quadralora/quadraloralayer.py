...
class QuadraLoraLayer(BaseTunerLayer):
...
class Linear(nn.Module, QuadraLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        QuadraLoraLayer.__init__(self, base_layer, **kwargs)
...
class Embedding(nn.Module, QuadraLoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        QuadraLoraLayer.__init__(self, base_layer)
...
class _ConvNd(nn.Module, QuadraLoraLayer):
